/*
========================================================================
파    일    명 : ImageListAdminController.java
========================================================================
작    성    자 : 강지호
작    성    일 : 2021.07.18
작  성  내  용 : 관리자의 회원 이미지 조회 컨트롤러
========================================================================
...
@Controller
@RequestMapping("/admin/pet/image")
public class ImageListAdminController {
	...
	public String listImageInsert(@PathVariable("memberNumber") int memberNumber,
		...
		if (deleteButton != null) {
			...
			return "redirect:/admin/pet/image/" + memberNumber + "?petRegistrationNumber=" + petRegistrationNumber;
		} else {
			try {
				...
				imageUploadService.uploadImage(memberNumber, file, rootPath, petRegistrationNumber);
				return "redirect:/admin/pet/image/" + memberNumber + "?petRegistrationNumber=" + petRegistrationNumber;
