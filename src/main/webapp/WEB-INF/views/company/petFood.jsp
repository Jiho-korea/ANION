...
<body>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="hero-cap hero-cap2 pt-70">
							<h2>
								<spring:message code="pet.food.title" />
							</h2>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html"><spring:message code="pet.food.title" /></a></li>
									<li class="breadcrumb-item"><a href="#"><spring:message code="pet.food" /></a></li>
								</ol>
							</nav>
						</div>
					</div>
	...
	<div class="visit-tailor-area fix">
		...
		<!-- left Contents -->
			<p>
				<img src="${pageContext.request.contextPath}/img/petFood/petFood_2.png" style="max-width: 100%; height: auto;" alt="">
			</p>
			<!--
	...
	<div class="container" id="main">
		<div class="jumbotron">
			<img src="${pageContext.request.contextPath}/img/petFood/petFood_3.png" style="max-width:100%;height:auto;margin-left:auto;margin-right:auto;display:block;" alt="" />
			<br><img src="${pageContext.request.contextPath}/img/petFood/petFood_4.png" style="max-width:100%;height:auto;margin-left:auto;margin-right:auto;display:block;" alt="" />
		</div>
	</div>
	<br>
