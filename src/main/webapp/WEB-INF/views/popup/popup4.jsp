...
<body
	background="${pageContext.request.contextPath}/img/popupBack/world_map.png">

	<c:forEach var="kindcode" items="${kindcodeList}" varStatus="status">
		<div
			style="position: absolute; left: 600px; top: 200px; width: 100px; height: 100px; cursor: pointer"
			onclick="location.href='${pageContext.request.contextPath}/popup/2/click/${kindcode.petKindcode}';">
			<img
				src="${pageContext.request.contextPath}/img/dog/jindot.png" width="100" height="100"/>
		</div>
	</c:forEach>
